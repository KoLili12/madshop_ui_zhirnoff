...
### ProductCard
Карточка товара с изображением товара, кнопкой добавления в избранное (сердечко), кнопкой добавления в корзину, названием и ценой товара, тенью и белым фоном.

### CartItemCard
Карточка товара в корзине с миниатюрой товара, информацией о цвете и размере, счётчиком количества (+/-), кнопкой удаления и отображением цены.
